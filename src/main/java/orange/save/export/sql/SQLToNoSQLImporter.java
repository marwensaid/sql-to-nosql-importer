...
public class SQLToNoSQLImporter {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ResourceBundle resourceBundle = args.length > 0 && args[0] != null ? getResourceBundle(args[0], Locale.US)
                : getDefaultRB(Locale.US);

        DataImporter dataImporter = new DataImporter(resourceBundle);
        dataImporter.setAutoCommitSize(Integer.valueOf(resourceBundle.getString("autoCommitSize")));
        dataImporter.doDataImport(dbConf);
    }
